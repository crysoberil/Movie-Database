<%@page import="com.movie.model.CelebrityModel"%>
...
<%
    ...
    int awyear;
    boolean f1 = false;
    ArrayList<PersonAward> showCelebAward = (ArrayList<PersonAward>) request
            .getAttribute("celebawards");

    String _celebName = (String) request.getAttribute("celebname");
    long _celebID = (Long) request.getAttribute("celebid");
    String _celebLink = showCelebAward.isEmpty() ? CelebrityModel
            .getCelebrityName(_celebID) : showCelebAward.get(0)
            .getCelebName();
%>


<title>Awards : <%=_celebName%></title>
	...
	<div class="jumbotron">
		<div class="container" align="center" id="header-wrap">
			...
			<h2 class="blog-post-title">
				<a href="<%=_celebLink%>"><%=_celebName%></a>
			</h2>
			<h2 class="blog-post-title">Awards</h2>
			<p>
				<%
				    if (showCelebAward.isEmpty()) {
				%>
				No award yet
				<%
				    }
		...
		<div class="container" style="color: rgb(48, 53, 54);">
			...
			<div class="row" style="font-size: large;">
				<div class="col-md-8">
					<dl>
						<%
						    for (PersonAward s : showCelebAward) {
						        link = s.getCelebProfileLink();
						        title = s.getCelebName();
