...
public class LoadFavoriteMoviesController extends CheckedHttpServlet {
    ...
    public void checkedDoGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (!isLoggedIn(req.getSession()))
            ...
            try {
                ...
                ArrayList<AddedMovieListElement> favoriteMovieList = MovieListModel
                        .getFavoriteMoviesList(userID);

                req.setAttribute("favoritemovieslist", favoriteMovieList);

                // TODO dispatch

                req.getRequestDispatcher("/WEB-INF/showfavoritemovies.jsp")
                        .forward(req, resp);
